...
export default function ReportePuntual({ isOpen, setShow }) {
  ...
  const handleConfirm = async () => {
    try {
      ...
      const excelData = reservas.map((r) => ({
        ...
        "Hora de Llegada": r.hora_llegada?.[0] ?? "",
        "Hora de Salida":
      ...
      XLSX.utils.book_append_sheet(workbook, worksheet, "Llegaron a Tiempo");
      ...
      saveAs(
        ...
        `Reporte-Puntuales-${fechaInicial}-${fechaFinal}.xlsx`
      );
      ...
      <div className="modal-dialog">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title">Reporte de Asistencias Puntuales</h5>
            <button
