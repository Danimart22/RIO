...
const ButtonUserDarkMode = (navDisabled,hiddenWinwdowPopup) => {
  ...
  return (
    <StyledWrapper>
      <label className="popup" onClick={()=>hiddenWinwdowPopup}  style={{background: darkMode ? "#2c2c2c" : "#eee", margin: 0}}>
        <input type="checkbox" />
...
export default ButtonUserDarkMode;
